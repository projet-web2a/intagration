                    ...
                    <li class="breadcrumb-item active">Evénement</li>
                            ...
                            <table  class="table table-bordered table-dark">
                                ...
                                <tr>
                                    ...
                                    <td scope="col" class="bg-primary">Nom de l'événement</td>
                                    <td scope="col" class="bg-primary">Date de début</td>
                                    <td scope="col" class="bg-primary">Date de fin</td>
                                    <td scope="col" class="bg-primary">Nombre de participant</td>
                                    <td scope="col" class="bg-primary">Nombre de vue</td>
                                    <td scope="col" class="bg-primary">Image</td>
                                    <td scope="col" class="bg-primary">Description</td>
                                    <td scope="col" class="bg-primary">Action</td>
                                </tr>
                                <?PHP
