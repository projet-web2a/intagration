                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header d-flex align-items-center">
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal" action="modifierlivr.php?id=<?=$_GET['id']?>"  method="post">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                   <input type="text" hidden class="form-control" name="username" value="<?php echo $m['username'] ?>">
												    ...
												    <div class="col-sm-9">
                                                   <input type="text" hidden class="form-control" name="adresseLivraison" value="<?php echo $m['adresseLivraison'] ?>">
                                                </div>
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="number" hidden class="form-control" name="num_tel" value="<?php echo $m['num_tel'] ?>" >
                                                </div>
