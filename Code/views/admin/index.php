          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                ...
                <!-- Notifications-->
                <li class="nav-item dropdown"> <a id="notifications" rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link"><i class="fa fa-bell-o"></i><span class="badge bg-red badge-corner"><?php if($n==0 && $nbr==0 && $nb==0){echo"0";}else if($n!=0 && $nbr==0 && $nb==0){echo"1";} else if($n==0 && $nbr!=0 && $nb==0){echo"1";} else if($n==0 && $nbr==0 && $nb!=0){echo"1";} else if($n!=0 && $nbr!=0 && $nb!=0){echo"3";} else if($n==0 && $nbr!=0 && $nb!=0){echo"2";} else if($n!=0 && $nbr!=0 && $nb==0){echo"2";} else if($n!=0 && $nbr==0 && $nb!=0){echo"2";}?></span></a>
              ...
              <li><a rel="nofollow" href="listedescommandes.php?maction=<?='notif'?>" class="dropdown-item"> 
                        <div class="notification">
                          <div class="notification-content"><i class="fa fa-envelope bg-green"></i>You have <?=$nb?>  orders </div>
                        </div></a></li>
