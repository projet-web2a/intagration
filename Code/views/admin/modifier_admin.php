...
return false;
  ...
  <nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark"><a class="navbar-brand" href="produit.html">    Edit</a>
...
<button type="submit" class="btn btn-primary" name="modifier" onclick="return verifad()" >Edit</button>
