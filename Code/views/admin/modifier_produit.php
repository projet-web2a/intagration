...
<script language="javascript" src="js/javafront.js" ></script>
 ...
 <!-- Side Navbar -->
  ...
  <nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark"><a class="navbar-brand" href="#">    Edit</a>
...
<div class="form-group">
  ...
  <button type="submit" class="btn btn-primary" name="modifier" onClick="verifm()">Edit</button>
</form>
