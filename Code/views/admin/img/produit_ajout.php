...
<script language="javascript" src="js/javafront.js" ></script>
      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
            ...
            <li class="active"><a href="produit_v.php"> <em class="icon-grid"></em>Produits </a></li>
            <li><a href="categorie_v.php"> <i class="fa fa-bar-chart"></i>Categorie </a></li>
  ...
  <nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark"><a class="navbar-brand" href="#">    Ajouter</a>
  ...
  <div class="card-body">
 <form name="f" method="POST" onsubmit="return verifm()" action="../../core/ajouterproduit.php">
  <div class="form-group">
    <label for="formGroupExampleInput">Référence</label>
    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="reference" name="refe" >
  </div>
  <div class="form-group">
    <label for="formGroupExampleInput2">Marque</label>
    <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="Marque" name="marque">
  </div>
  
  <label class="my-1 mr-2" for="inlineFormCustomSelectPref">Destinataire</label>
  <select class="custom-select my-1 mr-sm-2" id="inlineFormCustomSelectPref" name="destinataire" >
...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="formGroupExampleeInput" placeholder="Qte" name="qte">
  </div>
