                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal" action="modifierliv.php?id=<?php echo $_GET['id'] ?>" method="post">
                                            <div class="form-group row">
                                                ...
                                                <label type="email" class="col-sm-3 form-control-label" placeholder="mail@serveur.com">E-mail</label>
                                                <div class="col-sm-9">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="number" class="form-control" name="num_tel" value="<?php echo $m['num_tel'] ?>" >
                                                </div>
