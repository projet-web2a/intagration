                        ...
                        <table class="table table-striped table-sm table-dark">
                          <thead>
                            <tr>
                              ...
                              <th scope="col" class="bg-primary">Id Livreur </th>
                              <th scope="col" class="bg-primary">Ville</th>
                              <th scope="col" class="bg-primary">Adresse </th>
                              <th scope="col" class="bg-primary">Tél</th>
                              <th scope="col" class="bg-primary">Username </th>
                              <th scope="col" class="bg-primary">Id Commande</th>
                              <th scope="col" class="bg-primary">Date de livraison</th>
                          ...
                          <?php foreach ($livraisons as $li) { ?>
                            <tr>
                              ...
                              <td>
                                <a href="modifierlivraison.php?id=<?php echo $li['idLivraison']?>"  class="btn btn-info">Modifier</a> 
