       ...
       <!-- Side Navbar -->
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
           ...
           <li  class=""><a href="livraison.php"> <i class="icon-interface-windows"></i>Livraisons </a></li>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-sm table-dark">
                                            ...
                                            <tr>
                                                ...
                                                <th scope="col" class="bg-primary">Prénom</th>
                                                <th scope="col" class="bg-primary">E-mail</th>
                                                <th scope="col" class="bg-primary">Téléphone</th>
                                                <th scope="col" class="bg-primary">Nombre de livraisons</th>
                                            ...
                                            <?php foreach ($livraisons as $li) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <ul>
                                                            <a href="modifierlivreur.php?id=<?php echo $li['idLivreur']?>" class="btn btn-info">Modifier</a>
