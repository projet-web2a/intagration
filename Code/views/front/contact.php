...
require_once '../../core/avisC.php';
$reclam=new reclamationC();
$listeproduit=$reclam->recuperer_produit();
if (isset($_POST['Description']) and isset($_POST['sujet']) and isset($_POST['reference']))
{

if (empty($_SESSION['username']))
header('location: contact.php?login=1');
...
$sujet=$_POST['autre'];
	...
	$sujet=$_POST['sujet'];
$date = date("Y-m-d");
$reclam=new reclamation($sujet,$_POST['reference'],$_POST['Description'],$username,$date);
							...
							<div class="col-md-6 con-left">
  							...
  							<label for="sujet">Sujet</label>
 							 	 <select name="sujet" class="form-control">
 							 	 	variable
   								 <option class="dropdown-item">Produit Casse</option>
   								 <option class="dropdown-item">Information errone dans le catalogue ou sur le site web</option> 
   								 <option class="dropdown-item">Manquant a la livraison</option> 
   								 <option class="dropdown-item">Produit Commande errone</option> 
   								 <option class="dropdown-item">Produit livre non Commande</option> 
   								 <option class="dropdown-item">Autre</option> 
   								</select>
								</div>
								<div class="form-group">
									<label class="my-2">Si "Autre", merci de préciser</label>
									<input class="form-control" type="text" name="autre" placeholder="" >
								</div>
			               <div class="form-group">
			               <label for="reference">Reference</label>
 				              <select name="reference"class="form-control"  >
  	                           <?php foreach($listeproduit as $produit): ?>
                              <option class="dropdown-item"><?= $produit->refe; ?></option>
               			       <?php endforeach; ?>
               			   </select>
					         </div>
								<div class="form-group">
									<label>Description du problème rencontré </label>
