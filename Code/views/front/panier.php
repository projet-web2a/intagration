				...
				<div class="col-md-3 top-info-cart text-right mt-lg-4">
					<ul class="cart-inner-info">
						<li class="button-log">
							...
							<a class="btn-open" href="veriflogin.php?action=<?="logout"?>">
		...
		<div class="container">
			<div class="inner-sec-shop px-lg-4 px-3">
						...
						<tbody>
							...
							<tr class="rem1">
								...
								<td class="invert-image">
									<a href="single.php">
										<img src="images/<?= $produit->url ?>" alt=" " class="img-responsive" height=150>
									</a>
								</td>
								<td class="invert">
									<div class="quantity">
				...
				<div class="checkout-left row">
					<div class="col-md-4">
					  <h4> <a  class="btn btn-dark"  href="index1.php">Continue shopping</a></h4>
					   <ul>
					   						  		<?php $i=1; ?>
...
<?php if($nbArticles!=0) { ?>
										...
										<div class="card_number_grids">
											<div class="card_number_grid_left">
												<div class="controls">
													...
													<select class="btn-block" name="ville" class="form-control">
        ...
        <!-- Specify URLs -->
        <input type='hidden' name='cancel_return' value='http://localhost:8080/int%20final/views/front/paypal_cancel.php'>
		<input type='hidden' name='return' value='http://localhost:8080/int%20final/views/front/indexCommande.php'>
