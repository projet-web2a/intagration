...
$listeproduitC=$promotionC->afficherProduit1(); 
$nbArticles=0;
		...
		<header>
			<div class="row">
				<div class="col-md-3 top-info text-left mt-lg-4">
					...
					<ul><li class="nav-item dropdown"> <a id="notifications" rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link"><i class="fa fa-bell-o"></i><span class="badge bg-red badge-corner">You have <?PHP echo $nbr_notif ?> promotion(s) to discover </span></a>
                    <ul aria-labelledby="notifications" class="dropdown-menu">
                        <li><a rel="nofollow" href="#" class="dropdown-item">
                                <div class="notification">

                                    <div class="notification-content"><a href="afficherpromotion1.php "><i class="fa fa-envelope bg-green"></i>You have <?php echo $nbr_notif?> new promotion </a></div>
                                </div></a></li>
...
<div class="dropdown">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    <a class="dropdown-item" href="panier.php">My Cart <span class="badge badge-secondary nav-link-badge">
							<?=$nbArticles?></span></a>
									...
									<div class="info-product-price">
										...
										<div class="googles single-item hvr-outline-out">
											<form action="ajouterpannier.php?refe=<?=14?>"  method="post">
												...
												<input type="hidden" name="amount" value="1890.000">
